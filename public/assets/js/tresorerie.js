...
function justifRequis() {
	var div = document.getElementById("req_justif");
	var label = document.getElementById("req_justif_label");
	var checkbox = document.getElementById("req_justif_checkbox");

	if (checkbox.checked == 1)
	{
		label.innerHTML="Le champ \"Justificatif\" est requis";
			div.className=""; /* Si oui on affiche la div séparateur */
	}
	else
	{
		label.innerHTML="Le champ \"Justificatif\" n’est pas requis";
			div.className="invisible"; /* Si oui on affiche la div séparateur */
	}
}
