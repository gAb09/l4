...
class TypeController extends BaseController {
	...
	public function index()
	{
		...
		return View::Make('tresorerie.types.index')->with('types', $types);
	}
	...
	public function create()
	{
		...
		return View::Make('tresorerie.types.create')->with('type', $type);
	}
	...
	public function edit($id)
	{
		...
		return View::Make('tresorerie/types/edit')->with('type', $type);
	}
